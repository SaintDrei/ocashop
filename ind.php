...
================================================================================ -->
  <head>
    ...
    <!-- For Windows Phone -->
    <!-- CORE CSS-->
    <link href="https://pixinvent.com/materialize-material-design-admin-template/css/themes/fixed-menu/materialize.css" type="text/css" rel="stylesheet">
    <link href="https://pixinvent.com/materialize-material-design-admin-template/css/themes/fixed-menu/style.css" type="text/css" rel="stylesheet">
    <!-- Custome CSS-->
    <link href="../../css/custom/custom.css" type="text/css" rel="stylesheet">
    <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
    <link href="https://pixinvent.com/materialize-material-design-admin-template/vendors/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet">
  ...
  <body>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      ...
                      <a href="#">
                        <img src="../../images/gallary/10.png" alt="item-img">
                      </a>
                    </div>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/12.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/15.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/16.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/17.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/18.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/19.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/20.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/21.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/22.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
                ...
                <div class="item product">
                  <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                      <a href="#" class="btn-floating btn-large btn-price waves-effect waves-light teal accent-4">$189</a>
                      <a href="#">
                        <img src="../../images/gallary/23.png" alt="item-img">
                      </a>
                    </div>
                    <ul class="card-action-buttons">
                      <li>
    ...
    <!--prism-->
    <script type="text/javascript" src="https://pixinvent.com/materialize-material-design-admin-template/vendors/prism/prism.js"></script>
    <!--scrollbar-->
    <script type="text/javascript" src="https://pixinvent.com/materialize-material-design-admin-template/vendors/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <!-- masonry -->
    <script src="https://pixinvent.com/materialize-material-design-admin-template/vendors/masonry.pkgd.min.js"></script>
    <!-- imagesloaded -->
    <script src="https://pixinvent.com/materialize-material-design-admin-template/vendors/imagesloaded.pkgd.min.js"></script>
    <!--page-item.js - Page Specific JS codes-->
    <script type="text/javascript" src="https://pixinvent.com/materialize-material-design-admin-template/js/scripts/page-item.js"></script>
    <!--plugins.js - Some Specific JS codes for Plugin Settings-->
    <script type="text/javascript" src="https://pixinvent.com/materialize-material-design-admin-template/js/plugins.js"></script>
